...
public class form2 {
	...
	protected void createContents() {
		...
		txtUrl.setBounds(38, 10, 267, 21);
		
		Label lblUrl = new Label(shell, SWT.NONE);
		lblUrl.setBounds(10, 13, 22, 15);
		lblUrl.setText("url:");
		
		Browser browser = new Browser(shell, SWT.NONE);
		browser.setBounds(10, 65, 414, 257);
		...
		btnNewButton.setBounds(20, 34, 75, 25);
		...
		btnNewButton_1.setBounds(101, 34, 75, 25);
		...
		btnNewButton_2.setBounds(182, 37, 75, 25);
		...
		btnNewButton_3.setBounds(272, 37, 75, 25);
